...
RVOID 		dz_faw_multi_page_read_page_async_biodone_tail(PBIO);
RVOID 		dz_faw_multi_page_read_page_async_biodone_head(PBIO);
RVOID 		dz_faw_multi_block_read_page_async_parent_biodone(PBIO);

RVOID 		dz_fec_align_write_for_partial_block(PIOREQUEST );
PPAGE 		dz_faw_partial_block_read_page_sync(PIOREQUEST, PBIO, SECTOR);
RVOID 		dz_faw_partial_block_read_page_sync_biodone(PBIO);
RVOID 		dz_faw_partial_block_double_page_async(PIOREQUEST, SECTOR, BIODONE, BIODONE);
RVOID 		dz_faw_partial_block_double_page_async_biodone_head(PBIO);
RVOID 		dz_faw_partial_block_double_page_async_biodone_tail(PBIO);
RVOID 		dz_faw_partial_block_parent_biodone(PBIO);
