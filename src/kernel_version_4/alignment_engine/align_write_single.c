...
static RVOID dz_align_write_single_block_parent_biodone(PBIO bio)
{
...
static RVOID dz_align_write_single_block_double_page_async_biodone_head(PBIO bio)
{
	PIOREQUEST	ciorequest 	= (PIOREQUEST)(bio->bi_private);
	PIOREQUEST	piorequest 	= ciorequest->ior_parent;
	...
	*/
	...
	//IF_BIO_ERROR(bio) { IOREQUEST_DONE_ERROR(piorequest); goto exit; }
	...
	dz_align_write_single_block_parent_biodone(bio);
...
static RVOID dz_align_write_single_block_double_page_async_biodone_tail(PBIO bio)
{
	PIOREQUEST	ciorequest 	= (PIOREQUEST)(bio->bi_private);
	PIOREQUEST	piorequest 	= ciorequest->ior_parent;
	PBIO		parent_bio	= piorequest->ior_bio;
