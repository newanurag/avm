...
static RVOID dz_align_read_for_partial_block_biodone_tail(PBIO bio)
{
...
static RVOID dz_align_read_for_partial_block_biodone_head(PBIO bio)
{
	PIOREQUEST ciorequest 		= (PIOREQUEST) bio->bi_private;
	PIOREQUEST piorequest 		= ciorequest->ior_parent;
	PVOID   	cpagebuf		= NULL;
...
static RVOID dz_align_read_for_partial_block_biodone(PBIO bio)
{
	PIOREQUEST ciorequest 		= (PIOREQUEST) bio->bi_private;
	PIOREQUEST piorequest 		= ciorequest->ior_parent;
	PVOID   	cpagebuf		= NULL;
