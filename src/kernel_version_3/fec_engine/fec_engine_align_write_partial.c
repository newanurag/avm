...
RVOID dz_faw_partial_block_parent_biodone(PBIO bio, INT error)
{
...
RVOID dz_faw_partial_block_double_page_async_biodone_head(PBIO bio, INT error)
{
	PIOREQUEST	ciorequest 	= (PIOREQUEST)(bio->bi_private);
	PIOREQUEST	piorequest 	= ciorequest->ior_parent;
	...
	dz_faw_partial_block_parent_biodone(bio, error);
...
RVOID dz_faw_partial_block_double_page_async_biodone_tail(PBIO bio, INT error)
{
	PIOREQUEST	ciorequest 	= (PIOREQUEST)(bio->bi_private);
	PIOREQUEST	piorequest 	= ciorequest->ior_parent;
	PBIO		parent_bio	= piorequest->ior_bio;
