...
export DZ_PKG_BUILD_SCRIPT=${DZ_BUILD_PKG_DIR}/dz_presrcpkg.sh
...
SPEC_FILE=${DZ_BUILD_PKG_DIR}/dz_rpm.spec
...
cat ${STAT_FILE}
echo "Source Code RPM Package built successfully"
echo "Source Code RPM Package Name : "`basename $DZ_PACKAGE_DIR/*.rpm`
echo "Source Code RPM Package Path : "`dirname  $DZ_PACKAGE_DIR/*.rpm`
